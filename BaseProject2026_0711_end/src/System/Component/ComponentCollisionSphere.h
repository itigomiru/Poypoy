...
public:
    ...
    ComponentCollisionSpherePtr SetName(const std::string& name) { return Component::SetName<ComponentCollisionSphere>(name); }
...
protected:
    ...
    matrix old_attach_node_matrix_ = matrix::identity();
