...
public:
    ...
    ComponentCollisionCapsulePtr SetName(const std::string& name) { return Component::SetName<ComponentCollisionCapsule>(name); }
...
private:
    ...
    matrix old_attach_node_matrix_ = matrix::identity();    // 旧フレーム用マトリクス
